        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p className="text-gray-300">La meilleure expérience pour réserver votre hôtel partout dans le monde.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div className="flex">
                        ...
                        />
                        <button className="bg-indigo-600 text-white px-4 py-2 rounded-r-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            S inscrire
                        </button>
                    </div>
                </div>
